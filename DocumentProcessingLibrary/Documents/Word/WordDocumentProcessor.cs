...
public class WordDocumentProcessor : ITwoPassDocumentProcessor
{
    ...
    public WordDocumentProcessor(bool visible = false)
    {
        ...
        {
            Visible = visible, DisplayAlerts = InteropWord.WdAlertLevel.wdAlertsNone
        };
    }
    ...
    public ProcessingResult Process(DocumentProcessingRequest request)
    {
        ...
        object path = request.InputFilePath;
        ...
        try
        {
            ...
            {
                Document = doc, Application = _wordApp
            };
            ...
            {
                var docName = Path.GetFileNameWithoutExtension(request.InputFilePath);
                var pdfFileName = string.IsNullOrEmpty(request.ExportOptions.PdfFileName)
                    ? Path.Combine(request.OutputDirectory, docName + ".pdf")
    ...
    private void ExportToPdf(InteropWord.Document doc, string filename, PdfQuality quality)
    {
        ...
        {
            PdfQuality.Draft => InteropWord.WdExportOptimizeFor.wdExportOptimizeForOnScreen, PdfQuality.Standard => InteropWord.WdExportOptimizeFor.wdExportOptimizeForOnScreen, PdfQuality.HighQuality => InteropWord.WdExportOptimizeFor.wdExportOptimizeForPrint, _ => InteropWord.WdExportOptimizeFor.wdExportOptimizeForOnScreen
        };
